...
def fit_split_perf_vs_order_all_competitors(split_perf_df: pd.DataFrame, race_id: int or str,
                                       normalize_to_class=True, trend_type='linear'):
    """
    ...
    for competitor_id in split_perf_df[mask]['competitor_id'].unique():
        competitor_orders = split_perf_df[mask & (split_perf_df['competitor_id'] == competitor_id)]['split_order'].values
