...
def plot_split_performances(df: pd.DataFrame, race_name, tz, normalized=True, alpha=0.2, y_min=None, y_max=None,
    ...
    :param normalized: Whether to normalize the performances for an individual athlete or not
    ...
    plt.title(f'{race_name}\n'
              f'{"Normalized " if normalized else ""}Split Performance vs {"Athlete Start " if use_start_time else ""}Time\n'
